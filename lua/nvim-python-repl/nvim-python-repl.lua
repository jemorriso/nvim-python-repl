...
local get_statement_definition = function(filetype)
	...
	if filetype == "python" or filetype == "scala" or filetype == "markdown" then
		while
			...
			and string.match(node:sexpr(), "definition") == nil
			and string.match(node:sexpr(), "call_expression") == nil
		do
			node = node:parent()
		end
	elseif filetype == "lua" then
		while
			string.match(node:sexpr(), "for_statement") == nil
			and string.match(node:sexpr(), "if_statement") == nil
			and string.match(node:sexpr(), "while_statement") == nil
			and string.match(node:sexpr(), "assignment_statement") == nil
			and string.match(node:sexpr(), "function_definition") == nil
			and string.match(node:sexpr(), "function_call") == nil
			and string.match(node:sexpr(), "local_declaration") == nil
		do
			node = node:parent()
		end
	end
